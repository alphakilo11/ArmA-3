...
AK_var_westunits = "configName _x isKindOf 'CAManBase' and getNumber (_x >> 'scope') == 2 and getNumber (_x >> 'side') == 1" configClasses (configFile >> "CfgVehicles") apply {
	configName _x
};
AK_var_eastUnits = "configName _x isKindOf 'CAManBase' and getNumber (_x >> 'scope') == 2 and getNumber (_x >> 'side') == 0" configClasses (configFile >> "CfgVehicles") apply {
	configName _x
};
