...
_typleListPartyA = [_initialPartyA apply {
	typeOf _x
}, _desiredStrengthPartyA] call AK_fnc_TypeRatio;
_typleListPartyB = [_initialPartyB apply {
	typeOf _x
}, _desiredStrengthPartyB] call AK_fnc_TypeRatio;
