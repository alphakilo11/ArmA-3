...
// ENHANCE defaults for params 
 ...
 [ 
  ...
  [_angriffsZiel, _verteidigerRichtungVector, _verteidigerRichtung, _typleListDefenders, _verteidigerSide, _verteidigerAnzahl, _angriffsDistanz, _verteidigerFahrzeugAbstand, _gefechtsstreifenBreite, _angriffsZiel, true, true] 
 ] call CBA_fnc_waitUntilAndExecute; 
};