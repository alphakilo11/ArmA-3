...
The data is saved to AK_object_dataVault as variable named str _projectile. It includes following data:
...
*/   
	...
	AK_object_dataVault setVariable [_projectileString, [str _unit, _weapon, _muzzle, _mode, _ammo, _magazine, str _gunner, _shotTime, _firerPos, _muzzleVelocity, typeOf _unit]];
 ...
 _projectile addEventHandler ["Explode", {  
  ...
  private _data = AK_object_dataVault getVariable [str _projectile,  "None"];
 ...
 */
	...
	_projectile addEventHandler ["Deleted", { 
		params ["_projectile"];
		private _projectileString = str _projectile;
		private _projectileData = AK_object_dataVault getVariable [_projectileString,  "None"];
		...
		AK_object_dataVault setVariable [_projectileString, nil];
	...
	private _showData = AK_object_dataVault getVariable [_projectileString, "None"];
